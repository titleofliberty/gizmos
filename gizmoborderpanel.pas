...
type
  ...
  private
    FBorderColor: TColor;
    FBorderEndCap: TPenEndCap;
    FBorderStyle: TPenStyle;
    FBorderRadius: Integer;
    FBorderWidth: Integer;
    procedure SetBorderColor(AValue: TColor);
    procedure SetBorderEndCap(AValue: TPenEndCap);
  ...
  published
    ...
    property BorderEndCap : TPenEndCap read FBorderEndCap write SetBorderEndCap;
  end;
...
procedure TBorderPanel.SetBorderEndCap(AValue: TPenEndCap);
begin
  if FBorderEndCap = AValue then Exit;
  FBorderEndCap := AValue;
  Invalidate;
end;
...
begin
  ...
  begin
    ...
    Canvas.Pen.EndCap  := FBorderEndCap;
